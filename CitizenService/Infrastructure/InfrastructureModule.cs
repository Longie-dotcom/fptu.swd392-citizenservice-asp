    ...
    public static class InfrastructureModule
    {
                ...
                this IServiceCollection services)
        {
            ...
            try
            {
                ...
                var connectionString = Environment.GetEnvironmentVariable("CITIZEN_DB_CONNECTION");
                if (string.IsNullOrEmpty(connectionString))
                {
                    ServiceLogger.Error(
                        Level.Infrastructure, "Missing environment variable: CITIZEN_DB_CONNECTION");
                    throw new DatabaseConnectionException(
                        "Failed to configure Citizen database.");
                }
            ...
            {
                ServiceLogger.Error(
                    Level.Infrastructure, $"Failed to configure Citizen database: {ex.Message}");
                throw new DatabaseConnectionException(
                    "Failed to configure Citizen database.");
            }
