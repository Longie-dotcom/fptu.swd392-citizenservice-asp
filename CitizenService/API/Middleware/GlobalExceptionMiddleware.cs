    ...
    public class GlobalExceptionMiddleware
    {
        ...
        private async Task HandleExceptionAsync(HttpContext context, Exception exception)
        {
            ...
            switch (exception)
            {
                ...
                case 
                CitizenAreaAggregateException or
                CitizenProfileAggregateException:
                ...
                CollectionReportNotFound or
                ComplaintReportNotFound:
                    ServiceLogger.Warning(
                ...
                RPCConflict:
                    ServiceLogger.Warning(
                        Level.API, $"Resource is conflict: {exception.GetType().Name}, detail: {exception.Message}");
                ...
                default:
                    ServiceLogger.Error(
                        Level.API, $"Internal exception: {exception.GetType().Name}, detail: {exception.Message}");
